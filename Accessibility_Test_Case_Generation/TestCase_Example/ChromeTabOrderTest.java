...
public class ChromeTabOrderTest {
    private static final String TAG = "A11yTest";

    @Test
    public void testTabFocusOrder() throws Exception {
        UiDevice device = UiDevice.getInstance(InstrumentationRegistry.getInstrumentation());
        UiObject2 firstNode = device.findObject(By.res("com.android.chrome:id/url_bar"));
        UiObject2 secondNode = device.findObject(By.res("com.android.chrome:id/tab_switcher"));
        ...
        if (abnormalOrder) {
            try {
                File out = new File(Environment.getExternalStorageDirectory(), "chrome_focus.png");
