...
public class FacebookAdOrderTest {
    private static final String TAG = "A11yTest";

    @Test
    public void testAdFocusOrder() throws Exception {
        UiDevice device = UiDevice.getInstance(InstrumentationRegistry.getInstrumentation());
        UiObject2 firstNode = device.findObject(By.res("com.facebook.katana:id/sponsored_label"));
        UiObject2 secondNode = device.findObject(By.res("com.facebook.katana:id/author_name"));
        ...
        if (abnormalOrder) {
            try {
                File out = new File(Environment.getExternalStorageDirectory(), "fb_focus.png");
