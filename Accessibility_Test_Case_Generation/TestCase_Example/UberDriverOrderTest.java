...
public class UberDriverOrderTest {
    private static final String TAG = "A11yTest";

    @Test
    public void testDriverFocusOrder() throws Exception {
        UiDevice device = UiDevice.getInstance(InstrumentationRegistry.getInstrumentation());
        UiObject2 firstNode = device.findObject(By.res("com.ubercab:id/driver_rating"));
        UiObject2 secondNode = device.findObject(By.res("com.ubercab:id/driver_name"));
        ...
        if (abnormalOrder) {
            try {
                File out = new File(Environment.getExternalStorageDirectory(), "uber_focus.png");
