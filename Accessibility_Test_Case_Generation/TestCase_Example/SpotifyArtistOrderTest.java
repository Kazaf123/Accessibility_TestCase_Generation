...
public class SpotifyArtistOrderTest {
    private static final String TAG = "A11yTest";

    @Test
    public void testArtistFocusOrder() throws Exception {
        UiDevice device = UiDevice.getInstance(InstrumentationRegistry.getInstrumentation());
        UiObject2 firstNode = device.findObject(By.res("com.spotify.music:id/artist_name"));
        UiObject2 secondNode = device.findObject(By.res("com.spotify.music:id/track_title"));
        ...
        if (abnormalOrder) {
            try {
                File out = new File(Environment.getExternalStorageDirectory(), "spotify_focus.png");
