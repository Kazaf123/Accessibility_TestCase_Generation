...
public class PinterestDescOrderTest {
    private static final String TAG = "A11yTest";

    @Test
    public void testDescFocusOrder() throws Exception {
        UiDevice device = UiDevice.getInstance(InstrumentationRegistry.getInstrumentation());
        UiObject2 firstNode = device.findObject(By.res("com.pinterest:id/pin_description"));
        UiObject2 secondNode = device.findObject(By.res("com.pinterest:id/pin_image"));
        ...
        if (abnormalOrder) {
            try {
                File out = new File(Environment.getExternalStorageDirectory(), "pin_focus.png");
