...
public class GmailThreadOrderTest {
    private static final String TAG = "A11yTest";

    @Test
    public void testThreadFocusOrder() throws Exception {
        UiDevice device = UiDevice.getInstance(InstrumentationRegistry.getInstrumentation());
        UiObject2 firstNode = device.findObject(By.res("com.google.android.gm:id/snippet"));
        UiObject2 secondNode = device.findObject(By.res("com.google.android.gm:id/sender"));
        ...
        if (abnormalOrder) {
            try {
                File out = new File(Environment.getExternalStorageDirectory(), "gmail_focus.png");
